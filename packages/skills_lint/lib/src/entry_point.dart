...
For repo-wide config, create skills_lint.yaml with a
`skills_lint.directories` entry.
...
ArgParser _createArgParser(String helpFlag) {
  ...
  parser
    ...
    ..addFlag(
      ...
      negatable: false,
      hide: true,
      help: 'Allow misconfigured keys in skills_lint.yaml.',
    )
    ..addOption(
      _configOption,
      abbr: 'c',
