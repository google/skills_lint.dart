...
/// Benchmark for baseline-generation throughput using `bench_press`.
///
/// Measures the rate at which `validateSkills` with `--generate-baseline`
/// processes synthetic skills with recordable errors.
final class BaselineThroughputBenchmark extends AsyncBenchmark {
  BaselineThroughputBenchmark() : super('baseline_throughput');

  static const int _skillCount = 50;
  ...
  Future<void> setup() async {
    _tempDir = Directory.systemTemp.createTempSync('skills_lint_bench_');
...
void main(List<String> args) => mainAsyncBenchmark(BaselineThroughputBenchmark(), args);
